...
版本：v2.33 (2013-1-10) 作者：[deerchao](http://deerchao.net/)  转载请注明[来源](http://deerchao.net/tutorials/regex/regex.htm)
...
不同的环境下正则表达式的一些细节是不相同的，本教程介绍的是微软 .Net Framework 4.0 下正则表达式的行为，所以，我向你推荐我编写的.Net下的工具 [正则表达式测试器](../../tools/regex_tester/index.htm "转到RegexTester页面")。请参考该页面的说明来安装和运行该软件。

下面是Regex Tester运行时的截图：

[![正则表达式测试器运行截图](../../images/regex_tester.png)](http://deerchao.net/tools/regex_tester/index.htm)
...
要投诉我,或者觉得我其实可以忽悠得更高明,欢迎来[![](../../images/weibo.png)我的微博](http://weibo.com/deerchao/)让我知道. 如果你有关于正则表达式的问题, 可以到 [![](../../images/stackoverflow.png)stackoverflow](http://www.stackoverflow.com) 网站上提问, 记得要添加 regex 标签. 如果你更习惯于用中文交流, 可以到微博上用 #正则# 标签提出问题.
